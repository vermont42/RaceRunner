...
class UiConstants {
    ...
    static let intermediate1Color = UIColor(red: 237.0/255.0, green: 175.0/255.0, blue: 184.0/255.0, alpha: 1.0)
    static let intermediate2Color = UIColor(red: 222.0/255.0, green: 219.0/255.0, blue: 210.0/255.0, alpha: 1.0)
