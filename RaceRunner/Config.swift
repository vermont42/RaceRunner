...
struct Config {
  ...
  fileprivate static let googleMapsError = "Google Maps API key missing from Config.swift."
  fileprivate static let darkSkyError = "Dark Sky API key missing from Config.swift."
  fileprivate static let pubNubPublishError = "PubNub Publish API key missing from Config.swift."
  fileprivate static let pubNubSubscribeError = "PubNub Subscribbe API key missing from Config.swift."
